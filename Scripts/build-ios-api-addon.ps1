...
if ([int]$addonManifest.version_id -ne 1000018 -or $addonManifest.version_string -ne "1.0.18") {
    throw "IosApi package must be exactly 1.0.18 / 1000018 for this release."
}
