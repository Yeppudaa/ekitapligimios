...
`Scripts/apply-mobileapi-ios-patch.ps1` was tested against the local XenForo `Ekitapligim/MobileApi` addon at `C:\xampp\htdocs\ekitapligim\src\addons\Ekitapligim\MobileApi`; it upgraded the local addon to `1.0.82`, imported route and CLI data, passed PHP syntax checks, and created `Backend/packages/Ekitapligim-MobileApi-iOS-1.0.82.zip` (SHA-256 `E7805803071BB698C8083AE5D521985712F57E5C802123261B59AA057744D4FD`).
