...
Do not submit until every placeholder is replaced, MobileApi `1.0.81` or newer is on the public HTTPS environment, and the reviewer flow has been executed there.
